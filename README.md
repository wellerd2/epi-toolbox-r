...
### `compare_periods_by_species()`
Summarizes and compares model-based expected counts and incidence rates across two user-defined time periods using model outputs generated by the FoodNetTrends workflow. The function can be adapted to compare periods without stratifying by species by modifying the grouping structure used in the draw- and period-level summaries.
